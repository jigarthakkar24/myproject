...
urlpatterns = [
    ...
    url(r'^drafts/$', views.student_draft_list, name='student_draft_list'),
    url(r'^student/(?P<pk>\d+)/publish/$', views.student_publish, name='student_publish'),
    url(r'^student/(?P<pk>\d+)/remove/$', views.student_remove, name='student_remove'),
]
